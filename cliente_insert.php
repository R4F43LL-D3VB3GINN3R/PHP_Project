    ...
    <?php
        ...
        try {
            ...
            if ($_SERVER["REQUEST_METHOD"] === "GET") {
                ...
                $sql = "SELECT N_CLIENTE FROM TAB_CLIENTE WHERE N_CLIENTE = '$numCli' or NIF = '$nifCli'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    if ($contratoCli == "Sim") { //Se o cliente quer um contrato...
                        ...
                        $stmt = $conn->prepare("INSERT INTO TAB_CONTRATO (ID, TIPO_CONTRATO, TEMPO_TOTAL, DESLOCACAO, MODALIDADE, QUANT_DESLOCACOES)
                        VALUES (?, ?, ?, ?, ?, ?)");
                        $stmt->bind_param('isissi', $nifCli, $tipoContratoCli, $tempoTotalCli, $deslocacaoCli, $modalidadeCli, $num_viagensCli);
